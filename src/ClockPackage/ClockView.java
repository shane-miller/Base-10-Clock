...
public class ClockView extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        final double TEXTFIELD_LAYOUT_Y = 180;
        ...
        clockTimer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() { 
                    ...
                    timeString = String.format("%.4f", currentTime);
        ...
        /* Interval set to 8.64 seconds since that is how long it is between increments of 0.01 in base 10 time */
    }
}